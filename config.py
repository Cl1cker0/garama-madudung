...
MONEY_THRESHOLD = (0.1, 999.0) # in millions from, to / в миллионах от, до (example: 1.5 = 1.5m, 0.5 = 500k)
...
FILTER_BY_NAME = True, ["Graipuss Medussi", "La Grande Combinasion", "La Vacca Saturno Saturnita", "Agarrini la Palini", "Chimpanzini Spiderini", "Los Combinasionas", "Chicleteira Bicicleteira", "Los Tralaleritos", "Las Tralaleritas", "Job Job Job Sahur", "Bombardini Tortinii"] # filter by name, фильтр по имени
